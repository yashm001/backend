...
var web3 = new Web3(new Web3.providers.HttpProvider(config.connectionURLFTM));
...
module.exports = {
    ...
    //         tokenAddress = tokenList.tokenAddress(token,"FTM");
    //         bridgeDetail = tokenList.bridgeDetails(token,"FTM");
    ...
    getbalance: async (req, res) => {
        try {
            ...
            console.log("token",token)
            tokenDetail = tokenList.tokenDetails(token,"FTM");
