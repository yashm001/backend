...
const wrappedTokenAbi = require('./ABI/wrappedTokenABI.json')
...
module.exports = {
    ...
    getbalance: async (req, res) => {
        try {
            ...
            tokenDetail = tokenList.tokenDetails(token, "AVAX");
            tokenAddress = tokenDetail[0]
            decimal = tokenDetail[1]
            
            console.log("tokenAddress", tokenAddress)
            var tokenContract = await new web3.eth.Contract(wrappedTokenAbi, tokenAddress)
    ...
    getAmountAfterFee: async (req, res) => {
        try {
            ...
            bridgeDetail = tokenList.bridgeDetails(token, "AVAX");
            bridgeAddress = bridgeDetail[0]
